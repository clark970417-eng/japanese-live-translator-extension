...
- Title/manual post translation can use a contextual prompt. Viewer drafts use an explicit polite, gently cute style, with examples preserving negation and viewer perspective. NVIDIA Qwen or OpenRouter Gemma uses existing user credentials. The extension does not promise free quota or endpoint availability.
...
- [YouTube viewer chat archive](https://hololyzer.net/youtube/archive/superchat/czuuoH5f9IU.html): public mirror used to examine livestream vocabulary such as リアタイ and アーカイブ. The listed examples are newly authored short templates, not copied messages or training data.
- [X public reply mirror](https://twstalker.com/_manaka_430/status/2038162668532687130): attire-compliment register. This is a mirror, not direct X verification or a claim that all fans speak alike.
