> Latest incremental validation: [3.8.2 recording-drain retest](RETEST-3.8.2.md). The broader latency and translation-quality overhaul remains in progress.
...
Current validation: [3.8.2 verification and remaining checks](RETEST-3.8.2.md).
